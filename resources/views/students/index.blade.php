                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    @foreach($students as $s)
                                        @if($s->hoursRequested == 0)
                                            <tr <tr style="background-color:#A9A9A9">
                                        @else
                                            <tr>
                                        @endif
                                            ...
                                            <td class="text-center">{{$s->HoursFlown()}} (<small style="color:gray">{{number_format($s->CompletedHoursPercentage,0)}}%)</small></td>
                                            <td class="text-center">{{$s->RemainingHours}}</td>
                                            ...
                                            <td>
                                                ...
                                                @else
                                                    <a href="{{action('StudentsController@studentCheckout', $s->id)}}" title="Check Out" class="btn btn-dark"><i class="fa fa-balance-scale"></i></a>
                                                @endif
                                            </td>
                                        </tr>
                                    @endforeach
