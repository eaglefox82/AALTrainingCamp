...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="card card-stats">
                    @if($avgspend>($availableFunds/$campDays))
                <div class="card-header card-header-danger card-header-icon">
                  <div class="card-icon">
                  ...
                  <p class="card-category">Avgerage Spend per Day<br><br></p>
                  <h3 class="card-title">${{number_format((float)($avgspend), 2)}}</h3>
                </div>
                <div class="card-footer">
                </div>
              </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="card card-stats">
                    <div class="card-header card-header-warning card-header-icon">
                        ...
                        <p class="card-category">Spent Today<br><br></p>
                        <h3 class="card-title">${{number_format((float)($spendtoday), 2)}}</h3>
                    </div>
                    <div class="card-footer">
                    </div>
                </div>
